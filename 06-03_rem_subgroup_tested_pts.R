# ============================================================================ #
# 6. REM Analysis - COVID-19 Vaccine 3rd dose - Subgroup Tested Patients  #
...
ifelse(!dir.exists(here('Results', 'dose_3', 'sub_group_tested_patients')), dir.create(here('Results', 'dose_3', 'sub_group_tested_patients')), FALSE)
...
dfREMlong <- dfREMlong %>%
  ...
  mutate(age_bin_60 = if_else(age >= 60, 'Age 60+', 'Age < 60'),
      ...
      # Creating SUBGROUP for ANALYSIS (!)
      filter(n_covid_tests >= 1)
