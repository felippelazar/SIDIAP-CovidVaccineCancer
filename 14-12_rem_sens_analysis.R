# ============================================================================ #
# 14-12.REM Analysis - COVID-19 Vaccine 1st and 2nd Restricted Matching Cohort #
...
ifelse(!dir.exists(here('Results', 'dose_12', 'rem_sens_analysis')), dir.create(here('Results', 'dose_12', 'rem_sens_analysis')), FALSE)
...
# Make into dataframe
dfREM <- do.call(bind_rows, z_merge_1st2nd_sens)
