# ============================================================================ #
# 8. REM Analysis - COVID-19 Vaccine 3rd dose - Subgroup Cancer Strict         #
...
ifelse(!dir.exists(here('Results', 'dose_3', 'sub_group_cancer_strict')), dir.create(here('Results', 'dose_3', 'sub_group_cancer_strict')), FALSE)

# Loading Auxiliary Objects for Analayis
source('aux_objects_rem_3.R')
current_analysis <- 'sub_group_cancer_strict'
